...
random_genus4:=function(q,d)

  // return a random quadric of discriminant d (which is -1,0,1)
  // and a random cubic, both in 4 variables over finite field 
  // Fq that define a smooth curve of genus 4 in P^3 over Fq

  Fq:=FiniteField(q);
  R:=PolynomialRing(Fq,4);
